 ...
 *
 * 注: CLAUDE.md の「絶対に変更してはいけない設定ファイル」表と
 *     PROTECTED_FILES 配列は tests/consistency/protected-files.test.ts
 *     で整合性が検証されています。リストを変更する際は両方を更新してください。
 */
...
// 保護対象の設定ファイル
// CLAUDE.md「絶対に変更してはいけない設定ファイル」表と完全一致させること
